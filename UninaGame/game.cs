...
namespace UninaGame
{
    internal class Game : GameWindow
    {
        ...
        private const float DefaultMoveSensitivity = 0.01f;
        private const float DefaultAngle = 0.25f;
        private const int DefaultSpeed = 1;
        private const int DefaultXZSpeed = 5;
        private const int DefaultWidth = 1700;
        private const int DefaultHeight = 900;

        private bool click = false;
        private int speed = DefaultSpeed;
        private int xzSpeed = DefaultXZSpeed;
        private float buffer = 0f;
        private float angle = DefaultAngle;

        private Vector3 topPosition = new Vector3(0f, 0f, 0f);
        private Vector2 lastMoveMousePos;
        private bool firstMoveInput = true;
        private float moveSensitivity = DefaultMoveSensitivity;
